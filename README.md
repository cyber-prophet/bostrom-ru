...
Cyb.ai - это веб-интерфейс, который разрабатывается командной Bostrom. Cyb.ai получает данные о cyberlinks записанные blockchain Bostrom.

Результаты выдачи в cyb.ai это файлы, хранящиеся в IPFS, на IPFS хеш (particle, частица в терминах Bostrom) которых при помощи cyberlink ссылается IPFS хеш файла (другой частицы) из поисковой строки. 
