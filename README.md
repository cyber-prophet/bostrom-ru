...
Cyberlink - это два и более связанных particle зарегистрированных в блокчейне Bostrom. 

IPFS - это распределенная файловая система в которой все файлы пользователи хранят сами. Поэтому IPFS не гарантирует сохранность файлов. Зато позволяет обращаться к файлам по их hash.  Поэтому чем на большем количестве устройств находится файл - тем больше шансов (и потенциально быстрее) он загружается.
